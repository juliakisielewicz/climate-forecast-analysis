...
range(na.omit(as.numeric(SPEI_fore[,,7])))


grid_fore_spei <- expand.grid(lon=lon_fore, lat=lat_fore)
grid_fore_spei$z<-as.numeric(SPEI_fore[,,7])
...
levelplot(z ~ lon * lat, data=grid_fore_spei, at=cuts, pretty=T, col.regions=pal(8),aspect=range_fore_lat/range_fore_lon, main = "SPEI - July 2006")


plot(spei_fore_raster,main=time_fore[7],col=pal(8),breaks=cuts)
