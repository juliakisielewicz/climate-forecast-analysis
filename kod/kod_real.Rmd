...
range(na.omit(as.numeric(SPEI_real[,,175])))
cuts1 <- c(-3, -1.7, -1.3, -0.8, 0.0, 0.8, 1.3, 1.7, 3)
pal <- colorRampPalette(c("red","blue"))
cuts<-seq(-3,3,0.5)

july_real_6 <- seq(7, length(time_real), by=12)

for (i in july_real_6)
{
  ...
  plot(spei_real_raster,main= paste("6-month SPEI based on real data - ", time_real[i]),col=pal(12),breaks=cuts)
  plot(both,add=TRUE,lwd=2)
