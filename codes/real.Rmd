...
for (i in 1:tmax_real_dim[1]){
  print(i)
	for (j in 1:tmax_real_dim[2]){
		a<-as.vector(spei( as.numeric(ppt_real_array[i,j,]) - as.numeric(PET_real[i,j,]), 3)) #3 months
...
for (i in 1:tmax_real_dim[1]){
  print(i)
	for (j in 1:tmax_real_dim[2]){
		a<-as.vector(spei( as.numeric(ppt_real_array[i,j,]) - as.numeric(PET_real[i,j,]), 12)) #12 months
