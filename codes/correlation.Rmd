...
library(raster)
load("manual_tmp_complete_tmax.RData")
save(list=c("tmax_rasters", "tmin_rasters", "ppt_rasters", "correlation_spei", "corrs_tmax_p", "corrs_tmax_s", "correlation_tmax", "corrs_tmin_p",), file="manual_tmp_complete_tmax.RData")

save(list=c("tmin_rasters"), file="manual_tmp_tmin.RData")
load("manual_tmp_tmin.RData")

load("manual_tmp_corrs_tmin_s.RData")
save(list=c("corrs_tmin_s"), file="manual_tmp_corrs_tmin_s2.RData")
