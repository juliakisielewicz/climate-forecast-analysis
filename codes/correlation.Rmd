...
for (i in seq(1,12))
{
  corrs_p_tmax <- append(corrs_p_tmax, corLocal(tmax_real_stacks[i][[1]], tmax_fore_stacks[i][[1]], method="pearson", test=TRUE))
plot(corrs_p_tmax[i][[1]])
#corr_p_tmax_mask <- mask(corrs_p_tmax[i][[1]], corrs_p_tmax[i][[2]] < 0.05, maskvalue=FALSE)
...
for (i in seq(1,12))
{
  corrs_s_tmax <- append(corrs_s_tmax, corLocal(tmax_real_stacks[i][[1]], tmax_fore_stacks[i][[1]], method="spearman", test=TRUE))
plot(corrs_s_tmax[i][[1]])
#corr_p_tmax_mask <- mask(corrs_p_tmax[i][[1]], corrs_p_tmax[i][[2]] < 0.05, maskvalue=FALSE)
#plot(corr_p_tmax_mask)
#plot(both, add=TRUE, lwd=2)
}
...
for (i in seq(1,12))
{
  corrs_p_tmin <- append(corrs_p_tmin, corLocal(tmin_real_stacks[i][[1]], tmin_fore_stacks[i][[1]], method="pearson", test=TRUE))
plot(corrs_p_tmin[i][[1]])
#corr_p_tmin_mask <- mask(corrs_p_tmin[i][[1]], corrs_p_tmin[i][[2]] < 0.05, maskvalue=FALSE)
...
for (i in seq(1,12))
{
  corrs_s_tmin <- append(corrs_s_tmin, corLocal(tmin_real_stacks[i][[1]], tmin_fore_stacks[i][[1]], method="spearman", test=TRUE))
plot(corrs_s_tmin[i][[1]])
#corr_p_tmin_mask <- mask(corrs_p_tmin[i][[1]], corrs_p_tmin[i][[2]] < 0.05, maskvalue=FALSE)
#plot(corr_p_tmin_mask)
#plot(both, add=TRUE, lwd=2)
}
...
for (i in seq(1,12))
{
  corrs_p_ppt <- append(corrs_p_ppt, corLocal(ppt_real_stacks[i][[1]], ppt_fore_stacks[i][[1]], method="pearson", test=TRUE))
plot(corrs_p_ppt[i][[1]])
#corr_p_ppt_mask <- mask(corrs_p_ppt[i][[1]], corrs_p_ppt[i][[2]] < 0.05, maskvalue=FALSE)
...
for (i in seq(1,12))
{
  corrs_s_ppt <- append(corrs_s_ppt, corLocal(ppt_real_stacks[i][[1]], ppt_fore_stacks[i][[1]], method="spearman", test=TRUE))
plot(corrs_s_ppt[i][[1]])
#corr_p_ppt_mask <- mask(corrs_p_ppt[i][[1]], corrs_p_ppt[i][[2]] < 0.05, maskvalue=FALSE)
#plot(corr_p_ppt_mask)
#plot(both, add=TRUE, lwd=2)
}
