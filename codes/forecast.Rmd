...
for (i in 1:tmax_fore_dim[1]){
	for (j in 1:tmax_fore_dim[2]){
		print(i)
		a<-as.vector(spei( as.numeric(ppt_fore_array[i,j,]) - as.numeric(PET_fore[i,j,]), 3)) #1 month
...
for (i in 1:tmax_fore_dim[1]){
	for (j in 1:tmax_fore_dim[2]){
		print(i)
		a<-as.vector(spei( as.numeric(ppt_fore_array[i,j,]) - as.numeric(PET_fore[i,j,]), 12)) #1 month
