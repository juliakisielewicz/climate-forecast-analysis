...
for (i in 1:tmax_fore_dim[1]){
  print(i)
	for (j in 1:tmax_fore_dim[2]){
		a<-as.vector(spei( as.numeric(ppt_fore_array[i,j,]) - as.numeric(PET_fore[i,j,]), 1)) #1 month
...
for (i in 1:tmax_fore_dim[1]){
  print(i)
	for (j in 1:tmax_fore_dim[2]){
		a<-as.vector(spei( as.numeric(ppt_fore_array[i,j,]) - as.numeric(PET_fore[i,j,]), 3)) #3 months
...
for (i in 1:tmax_fore_dim[1]){
  print(i)
	for (j in 1:tmax_fore_dim[2]){
		a<-as.vector(spei( as.numeric(ppt_fore_array[i,j,]) - as.numeric(PET_fore[i,j,]), 6)) #6 months
...
for (i in 1:tmax_fore_dim[1]){
  print(i)
	for (j in 1:tmax_fore_dim[2]){
		a<-as.vector(spei( as.numeric(ppt_fore_array[i,j,]) - as.numeric(PET_fore[i,j,]), 12)) #12 months
